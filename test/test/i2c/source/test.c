...
static FW_BOOLEAN Test_I2C_Init(void)
{
  ...
  LOG("*** The BH1750 sensor must be connected to the I2C bus! ***\r\n");
...
static FW_BOOLEAN Test_BH1750_Init(void)
{
  ...
  LOG(" - Send BH1750 Power On command\r\n");
...
static FW_BOOLEAN Test_BH1750_Read(void)
{
  ...
  for (i = 0; i < 5; i++)
  {
    ...
    LOG(" - Send BH1750 High Resolution Mode 2 command\r\n");
