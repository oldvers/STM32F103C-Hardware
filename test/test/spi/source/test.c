...
static FW_BOOLEAN Test_SPI1_Init(void)
{
  ...
  LOG("*** The SPI1 MISO/MOSI lines must be connected together! ***\r\n");
...
static FW_BOOLEAN Test_SPI1_Exchange(void)
{
  ...
  {
    LOG(" - Echo received from SPI1\r\n");
  }
  else
  {
    LOG(" - No any data received from SPI1\r\n");
    result &= FW_FALSE;
  }
...
static FW_BOOLEAN Test_SPI2_Init(void)
{
  ...
  LOG("*** The SPI2 MISO/MOSI lines must be connected together! ***\r\n");
...
static FW_BOOLEAN Test_SPI2_Exchange(void)
{
  ...
  if ( (FW_TRUE == result) && (0 == memcmp(gTxBuffer, gRxBuffer, 10)) )
  {
    LOG(" - Echo received from SPI2\r\n");
  }
  else
  {
    LOG(" - No any data received from SPI2\r\n");
    result &= FW_FALSE;
  }
